...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_pwd = config['database_pwd']
        self.database_path = f'postgresql://{self.database_user}:{self.database_pwd}@{self.database_host}/{self.database_name}'
    ...
    def test_get_paginated_questions_invalid_page_404(self):
    ...
    def test_create_question_success(self):
        ...
        with self.app.app_context():
            Question.query.filter(Question.question ==
                                  self.new_question['question']).delete()
            db.session.commit()

    def test_create_question_invalid_category_422_unprocessable(self):
        """Test create question with invalid category id"""
        invalid_question = {
            'question': 'Question',
            'answer': 'Answer',
            'category': 20,
    ...
    def test_create_question_empty_question_422_unprocessable(self):
        """Test create question with empty question"""
        invalid_question = {
            'question': '',
            'answer': 'Answer',
            'category': 20,
    ...
    def test_create_question_empty_answer_422_unprocessable(self):
        """Test create question with empty answer"""
        invalid_question = {
            'question': 'Question',
            'answer': '',
            'category': 20,
    ...
    def test_create_question_none_answer_422_unprocessable(self):
        """Test create question with none answer"""
        invalid_question = {
            'question': 'Question',
            'answer': None,
            'category': 20,
    ...
    def test_create_question_none_question_422_unprocessable(self):
        """Test create question with none question"""
        invalid_question = {
            'question': None,
            'answer': 'Answer',
            'category': 20,
    ...
    def test_search_question_emtpy_results(self):
        ...
        res = self.client().post('/api/v1.0/questions/search',
                                 query_string={'search_term': 'blablabla'})
        self.assertEqual(res.status_code, 200)
        data = json.loads(res.data)
        self.assertTrue(data['success'])
    ...
    def test_play_quiz_with_previous_success(self):
        ...
        res = self.client().post('/api/v1.0/quizzes',
                                 json={'previous_questions': [20, 22], 'quiz_category': {'id': 1}})
        data = json.loads(res.data)
        self.assertTrue(data['success'])
    ...
    def test_play_quiz_no_more_questions(self):
        ...
        res = self.client().post('/api/v1.0/quizzes',
                                 json={'previous_questions': [20, 21, 22], 'quiz_category': {'id': 1}})
        data = json.loads(res.data)
        self.assertTrue(data['success'])
    ...
    def test_play_quiz_invalid_category_id(self):
        ...
        res = self.client().post('/api/v1.0/quizzes',
                                 json={'previous_questions': [5], 'quiz_category': {'id': 12345}})
        data = json.loads(res.data)
        self.assertTrue(data['success'])
        self.assertIsNone(data['question'])
